...
ClippedGenerator::ClippedGenerator(Generator* g)
   : generator(g),
     old_exists(false) {
   qiLogVerbose("Motion") << "ClippedGenerator constructed" << std::endl;
}

ClippedGenerator::~ClippedGenerator() {
   delete generator;
   qiLogVerbose("Motion") << "ClippedGenerator destroyed" << std::endl;
}
...
JointValues ClippedGenerator::makeJoints(ActionCommand::All* request,
                                         ...
                                         float ballX,
                                         float ballY) {
   qiLogVerbose("Motion") << "Clipped Generator make joints" << std::endl;
