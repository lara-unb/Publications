...
ActionGenerator::~ActionGenerator() {
   qiLogVerbose("Motion") << "ActionGenerator destroyed" << std::endl;
};
...
JointValues ActionGenerator::makeJoints(ActionCommand::All* request,
   ...
   qiLogVerbose("Motion") << "Make Action " << request->body.actionType << std::endl;
...
void ActionGenerator::interpolate(JointValues newJoint, int duration) {
   if (joints.empty()) {
      ...
      qiLogVerbose("Motion") << "MAX_ITER0: " << max_iter << std::endl;
      ...
      if (duration != 0) {
         qiLogVerbose("Motion") << "MAX_ITERIF: " << max_iter << std::endl;
         ...
         qiLogVerbose("Motion") << "MAX_ITERELSE: " << max_iter << std::endl;
...
void ActionGenerator::constructPose(std::string path) {
   ...
   qiLogVerbose("Motion") << "ActionGenerator(" << file_name << ") creating" << endl;
   ...
   qiLogVerbose("Motion") << "ActionGenerator(" << file_name << ") created" << endl;
}
