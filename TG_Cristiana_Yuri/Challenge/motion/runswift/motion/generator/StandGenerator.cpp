...
StandGenerator::StandGenerator()
   ...
   qiLogVerbose("Motion") << "StandGenerator constructed" << std::endl;
...
StandGenerator::~StandGenerator() {
   qiLogVerbose("Motion") << "StandGenerator destroyed" << std::endl;
   delete posGen;
}
...
//   joints.stiffnesses[i++] = 0.0f;  // RElbowRoll
   qiLogVerbose("Motion") << "Stand Generator" << std::endl;
...
//   qiLogVerbose("Motion") << "Successfully changed stand generator options" << std::endl;
//   qiLogVerbose("Motion") << "Stand generator options ignored" << std::endl;
}
