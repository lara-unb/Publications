...
Walk2014Generator::Walk2014Generator(/*Blackboard *bb*/)
   ...
   initialise();
   qiLogVerbose("Motion") << "Walk2014Generator constructed" << std::endl;

}

Walk2014Generator::~Walk2014Generator() {
   qiLogVerbose("Motion") << "Walk2014Generator destroyed" << std::endl;
}

void Walk2014Generator::initialise() {
	qiLogVerbose("Motion") << "Walk2014 initializing" << endl;
...
void Walk2014Generator:: reset() {
   initialise();
   qiLogVerbose("Motion") << "Walk2014 reset" << endl;
}

void Walk2014Generator:: stop() {
   // this does nothing
   stopping = true;
   qiLogVerbose("Motion") << "Walk2014 stop" << endl;
}
