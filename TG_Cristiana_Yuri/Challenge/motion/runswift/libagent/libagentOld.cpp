             ...
             if (skipped_frames > MAX_SKIPS) {
                ...
                if (!fork()) {
                 ...
                 //   ret = system("/usr/bin/killall runswift");
                   ret = system("/usr/bin/killall ChallengeNoWifi");
                 //   ret = execlp("/home/nao/bin/runswift", "runswift", (char*)NULL);
                   ret = execlp("/home/nao/naoqi/ChallengeNoWifi", "-m R", (char*)NULL);
                }
             } else {
                SAY("killed receiver");
                ret = system("/usr/bin/killall ChallengeNoWifi");
            ...
            if (skipped_frames > MAX_SKIPS) {
               ...
               if (!fork()) {
                ...
                //   ret = system("/usr/bin/killall runswift");
                  ret = system("/usr/bin/killall ChallengeNoWifi");
                //   ret = execlp("/home/nao/bin/runswift", "runswift", (char*)NULL);
                  ret = execlp("/home/nao/naoqi/ChallengeNoWifi", "-m T", "--rport 10100", (char*)NULL);
               }
            } else {
               SAY("killed transmitter");
               ret = system("/usr/bin/killall ChallengeNoWifi");
               ret = execlp("/home/nao/naoqi/matador", (char*)NULL);
               while (waitpid(-1, NULL, WNOHANG) > 0) ;
            }
