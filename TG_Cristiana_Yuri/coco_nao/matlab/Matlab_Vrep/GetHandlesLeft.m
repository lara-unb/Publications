function handles = GetHandles(clientID, vrep)
    ...
    %Joints
    [~,joints_handles(1)] = vrep.simxGetObjectHandle(clientID, 'LShoulderPitch3', vrep.simx_opmode_oneshot_wait); %Shoulder Pitch handle
    [~,joints_handles(2)] = vrep.simxGetObjectHandle(clientID, 'LShoulderRoll3', vrep.simx_opmode_oneshot_wait); %Shoulder Roll handle
    [~,joints_handles(3)] = vrep.simxGetObjectHandle(clientID, 'LElbowYaw3', vrep.simx_opmode_oneshot_wait); %Elbow Yaw handle
    [~,joints_handles(4)] = vrep.simxGetObjectHandle(clientID, 'LElbowRoll3', vrep.simx_opmode_oneshot_wait); %Elbow Roll handle
    [~,joints_handles(5)] = vrep.simxGetObjectHandle(clientID, 'LWristYaw3', vrep.simx_opmode_oneshot_wait); %Wrist Yaw handle
