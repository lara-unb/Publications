...
{
	class AbsoluteController : public DQ_controller
	{
	public:
	...
	private:
	    ...
	    MatrixXd absolute_jacobian_pseudoinverse_;
	...
	public: //methods
	    ...
	    AbsoluteController(DQ_kinematics robot_armR, DQ_kinematics robot_armL, float translation_feedback_gain, double translation_damping);
	    ~AbsoluteController(){};
