...
{
	class RelativeController : public DQ_controller
	{
	public:
	...
	private:
	    ...
	    MatrixXd relative_jacobian_pseudoinverse_;
	...
	public: //methods
	    ...
	    RelativeController(DQ_kinematics robot_armR, DQ_kinematics robot_armL, float translation_feedback_gain, double translation_damping);
	    ~RelativeController(){};
